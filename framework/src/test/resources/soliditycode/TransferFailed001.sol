contract EnergyOfTransferFailedTest {
    ...
    function testCallWyzInsufficientBalance(uint256 i,address payable caller) public {
    ...
    function testSendWyzNonexistentTarget(uint256 i,address payable nonexistentTarget) payable public {
        nonexistentTarget.send(i);
    }

    function testSendWyzRevert(uint256 i,address payable nonexistentTarget) payable public {
        nonexistentTarget.send(i);
        revert();
    }

    function testTransferWyzNonexistentTarget(uint256 i,address payable nonexistentTarget) payable public {
        nonexistentTarget.transfer(i);
    }

    function testTransferWyzrevert(uint256 i,address payable nonexistentTarget) payable public{
        nonexistentTarget.transfer(i);
        revert();
    }
    ...
    function testCallWyzNonexistentTarget(uint256 i,address payable nonexistentTarget) payable public {
