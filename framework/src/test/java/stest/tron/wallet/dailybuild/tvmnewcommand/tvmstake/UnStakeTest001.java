...
public class UnStakeTest001 {
  ...
  public void wvmStakeTest001Normal() {
    PublicMethed
  ...
  public void wvmUnstakeTest002NoStake() {
    PublicMethed
        .sendcoin(testAddress001, 1120_000_000L, testFoundationAddress, testFoundationKey,
            blockingStubFull);
    PublicMethed.waitProduceNextBlock(blockingStubFull);
  ...
  public void wvmUnstakeTest003UnstakeTwice() {
    PublicMethed
        .sendcoin(testAddress001, 1120_000_000L, testFoundationAddress, testFoundationKey,
            blockingStubFull);
    PublicMethed.waitProduceNextBlock(blockingStubFull);
  ...
  public void wvmUnstakeTest004Revert() {
    PublicMethed
        .sendcoin(testAddress001, 1120_000_000L, testFoundationAddress, testFoundationKey,
            blockingStubFull);
    PublicMethed.waitProduceNextBlock(blockingStubFull);
  ...
  public void wvmUnstakeTest005CallAnotherInOneContract() {
    PublicMethed
  ...
  public void wvmUnstakeTest006WithRewardBalance() {
    PublicMethed
        .sendcoin(testAddress001, 1120_000_000L, testFoundationAddress, testFoundationKey,
            blockingStubFull);
    PublicMethed.waitProduceNextBlock(blockingStubFull);
