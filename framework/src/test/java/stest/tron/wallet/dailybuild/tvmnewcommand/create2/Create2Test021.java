package stest.tron.wallet.dailybuild.wvmnewcommand.create2;
...
public class Create2Test021 {
  ...
  public void test1TriggerContract() {
    ...
    //Trigger contract to transfer wyz and token.
  ...
  @Test(enabled = true, description = "Create2 contract can transfer wyz and token.")
