...
public class TransactionFee001 {
  ...
  Long beforeBurnWyzAmount = 0L;
  Long afterBurnWyzAmount = 0L;
  String txid = null;
  ...
  public void test01DeployContractEnergyFeeToSr() {
    ...
    beforeBurnWyzAmount = blockingStubFull
        .getBurnWyz(EmptyMessage.newBuilder().build()).getNum();
    ...
    afterBurnWyzAmount = blockingStubFull
        .getBurnWyz(EmptyMessage.newBuilder().build()).getNum();
    Assert.assertEquals(beforeBurnWyzAmount,afterBurnWyzAmount);
  }
  ...
  public void test02UpdateAccountPermissionAndMultiSiginTrans() {
    ...
    afterBurnWyzAmount = blockingStubFull
        .getBurnWyz(EmptyMessage.newBuilder().build()).getNum();
    Assert.assertTrue(afterBurnWyzAmount - beforeBurnWyzAmount == 100000000L);
    ...
    afterBurnWyzAmount = blockingStubFull
        .getBurnWyz(EmptyMessage.newBuilder().build()).getNum();
    Assert.assertTrue(afterBurnWyzAmount - beforeBurnWyzAmount == 1000000L);
  }
  ...
  public void test03OutOfTimeEnergyFeeToBlackHole() {
    ...
    afterBurnWyzAmount = blockingStubFull
        .getBurnWyz(EmptyMessage.newBuilder().build()).getNum();
    Assert.assertTrue(afterBurnWyzAmount - beforeBurnWyzAmount == maxFeeLimit);
  }
  ...
  public void test04AccountCreate() {
    ...
    afterBurnWyzAmount = blockingStubFull
        .getBurnWyz(EmptyMessage.newBuilder().build()).getNum();
    Assert.assertTrue(afterBurnWyzAmount - beforeBurnWyzAmount == 100000L);
  }
  ...
  public void test06CreateAssetIssue() {
    ...
    afterBurnWyzAmount = blockingStubFull
        .getBurnWyz(EmptyMessage.newBuilder().build()).getNum();
    Assert.assertTrue(afterBurnWyzAmount - beforeBurnWyzAmount == 1024000000L);
  ...
  @Test(enabled = true, description = "Test getburnwyz api from solidity or pbft")
  public void test07GetBurnWyzFromSolidityOrPbft() {
    PublicMethed.waitSolidityNodeSynFullNodeData(blockingStubFull,blockingStubSolidity);
    Assert.assertEquals(blockingStubFull
        .getBurnWyz(EmptyMessage.newBuilder().build()),blockingStubSolidity.getBurnWyz(
        EmptyMessage.newBuilder().build()));
    Assert.assertEquals(blockingStubFull.getBurnWyz(EmptyMessage.newBuilder().build()),
        blockingStubPbft.getBurnWyz(
            EmptyMessage.newBuilder().build()));
  }
  /**
   * constructor.
