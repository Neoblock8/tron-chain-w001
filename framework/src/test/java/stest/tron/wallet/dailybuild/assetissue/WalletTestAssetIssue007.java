...
public class WalletTestAssetIssue007 {
  ...
  private static final Integer wyzNum = 1;
  ...
  public void testParticipateAssetIssueUseParticipateBandwidth() {
    ...
    Assert.assertTrue(PublicMethed
        .createAssetIssue(asset007Address, name, totalSupply, wyzNum, icoNum, start, end, 1,
    ...
    Assert.assertTrue(beforeBalance - wyzNum * 1 * icoNum >= afterBalance);
  }
