...
public class TransferFailed002 {
  ...
  public void test1SendNotEnough() {
    ...
    String num = "3000001";
    txid = PublicMethed
        .triggerContract(contractAddress, "testSendWyzInsufficientBalance(uint256)", num, false, 0,
  ...
  @Test(enabled = true, description = "Send wyz nonexistent target")
  public void test3SendWyzNonexistentTarget() {
    ...
    txid = PublicMethed
        .triggerContract(contractAddress, "testSendWyzNonexistentTarget(uint256,address)", num,
  ...
  @Test(enabled = true, description = "Send wyz self")
  public void test4SendWyzSelf() {
    Account info;
    ...
    String num = "1";
    txid = PublicMethed
        .triggerContract(contractAddress, "testSendWyzSelf(uint256)", num, false, 0, maxFeeLimit,
  ...
  @Test(enabled = true, description = "Send wyz nonexistent target and balance not enough")
  public void test5SendWyzNonexistentTarget() {
    Account info;
  ...
  @Test(enabled = true, description = "Send wyz self and balance not enough")
  public void test6SendWyzSelf() {
    Account info;
  ...
  @Test(enabled = true, description = "Send wyz nonexistent target, but revert")
  public void test7SendWyzNonexistentTargetRevert() {
    ...
    txid = PublicMethed
        .triggerContract(contractAddress, "testSendWyzRevert(uint256,address)", num, false, 0,
            maxFeeLimit, contractExcAddress, contractExcKey, blockingStubFull);
    Optional<TransactionInfo> infoById = null;
    PublicMethed.waitProduceNextBlock(blockingStubFull);
    infoById = PublicMethed.getTransactionInfoById(txid, blockingStubFull);
