...
public class StackSuicideTest001 {
  ...
  @Test(enabled = false, description = "targetAddress no WYZ, and no frozen")
  ...
  @Test(enabled = false, description = "targetAddress has WYZ, but no frozen")
  ...
  @Test(enabled = false, description = "targetAddress has WYZ, and has frozen")
