package stest.tron.wallet.dailybuild.wvmnewcommand.transferfailed;
...
public class TransferFailed001 {
  ...
  @Test(enabled = true, description = "Transfer wyz insufficient balance")
  public void test001TransferWyzInsufficientBalance() {
    ...
    txid = PublicMethed.triggerContract(contractAddress,
        "testTransferWyzInsufficientBalance(uint256)", num, false,
  ...
  @Test(enabled = true, description = "Transfer wyz nonexistent target")
  public void test003TransferWyzNonexistentTarget() {
    ...
    txid = PublicMethed.triggerContract(contractAddress,
        "testTransferWyzNonexistentTarget(uint256,address)", num, false,
        0, maxFeeLimit, contractExcAddress, contractExcKey, blockingStubFull);
    Optional<TransactionInfo> infoById = null;
    PublicMethed.waitProduceNextBlock(blockingStubFull);
    infoById = PublicMethed.getTransactionInfoById(txid, blockingStubFull);
  ...
  @Test(enabled = true, description = "Transfer wyz to myself")
  public void test004TransferWyzSelf() {
    ...
    txid = PublicMethed.triggerContract(contractAddress,
        "testTransferWyzSelf(uint256)", num, false,
        0, maxFeeLimit, contractExcAddress, contractExcKey, blockingStubFull);
    Optional<TransactionInfo> infoById = null;
    PublicMethed.waitProduceNextBlock(blockingStubFull);
    infoById = PublicMethed.getTransactionInfoById(txid, blockingStubFull);
    ...
    Assert.assertEquals("transfer wyz failed: Cannot transfer WYZ to yourself.",
        ByteArray.toStr(infoById.get().getResMessage().toByteArray()));
  ...
  @Test(enabled = true, description = "Transfer wyz nonexistent target and insufficient balance")
  public void test005TransferWyzNonexistentTarget() {
  ...
  @Test(enabled = true, description = "Transfer wyz to myself and insufficient balance")
  public void test006TransferWyzSelf() {
  ...
  @Test(enabled = true, description = "transferWyz to nonexistent target ,but revert")
  public void test010TransferRevert() {
    ...
    txid = PublicMethed.triggerContract(contractAddress,
        "testTransferWyzrevert(uint256,address)", num, false,
        0, maxFeeLimit, contractExcAddress, contractExcKey, blockingStubFull);
    Optional<TransactionInfo> infoById = null;
    PublicMethed.waitProduceNextBlock(blockingStubFull);
    infoById = PublicMethed.getTransactionInfoById(txid, blockingStubFull);
