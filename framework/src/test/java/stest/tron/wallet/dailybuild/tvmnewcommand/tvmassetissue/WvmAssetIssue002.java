package stest.tron.wallet.dailybuild.wvmnewcommand.wvmassetissue;
...
public class WvmAssetIssue002 {
  ...
  public void tokenIssue001IllegalParameterVerification() {
    ...
    String filePath = "./src/test/resources/soliditycode/wvmAssetIssue001.sol";
    String contractName = "wvmAssetIssue001";
    ...
    // assetName is wyz
    String tokenName = PublicMethed.stringToHexString("wyz");
    ...
    // totalSupply is -1
    tokenName = PublicMethed.stringToHexString(name);
    tokenAbbr = PublicMethed.stringToHexString("wyz");
    param =
    ...
    Assert.assertEquals("wyz", ByteArray.toStr(assetIssueById.getAbbr().toByteArray()));
    assetV2Map = PublicMethed.queryAccount(contractAddress, blockingStubFull)
        .getAssetV2Map();
  ...
  @Test(enabled = false, description = "tokenIssue wyz balance insufficient")
  public void tokenIssue002WyzBalanceInsufficient() {
    Assert.assertTrue(PublicMethed
        .sendcoin(dev001Address, 3100_000_000L, fromAddress, testKey002, blockingStubFull));
    PublicMethed.waitProduceNextBlock(blockingStubFull);
    String filePath = "./src/test/resources/soliditycode/wvmAssetIssue001.sol";
  ...
  public void tokenIssue003CalledMultipleTimesInOneContract() {
    Assert.assertTrue(PublicMethed
        .sendcoin(dev001Address, 3100_000_000L, fromAddress, testKey002, blockingStubFull));
    PublicMethed.waitProduceNextBlock(blockingStubFull);
    String filePath = "./src/test/resources/soliditycode/wvmAssetIssue002.sol";
    String contractName = "wvmAssetIssue002";
    HashMap retMap = PublicMethed.getBycodeAbi(filePath, contractName);
    String code = retMap.get("byteCode").toString();
    String abi = retMap.get("abI").toString();
  ...
  public void tokenIssue004Revert() {
    Assert.assertTrue(PublicMethed
        .sendcoin(dev001Address, 3100_000_000L, fromAddress, testKey002, blockingStubFull));
    PublicMethed.waitProduceNextBlock(blockingStubFull);
    String filePath = "./src/test/resources/soliditycode/wvmAssetIssue003.sol";
    String contractName = "wvmAssetIssue003";
    HashMap retMap = PublicMethed.getBycodeAbi(filePath, contractName);
    String code = retMap.get("byteCode").toString();
    String abi = retMap.get("abI").toString();
  ...
  public void tokenIssue005CallAnotherInOneContract() {
    ...
    String filePath = "./src/test/resources/soliditycode/wvmAssetIssue004.sol";
    String contractName = "wvmAssetIssue004";
    HashMap retMap = PublicMethed.getBycodeAbi(filePath, contractName);
    String code = retMap.get("byteCode").toString();
    String abi = retMap.get("abI").toString();
