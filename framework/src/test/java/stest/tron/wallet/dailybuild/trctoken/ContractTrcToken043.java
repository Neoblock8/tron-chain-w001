...
public class ContractTrcToken043 {
  ...
  public void test03TriggerContract() {
    ...
    // tokenId is 0, contract not have wyz
    ...
    // tokenId is 0, account does not have wyz
    ...
    // tokenId is 0, transfer contract has wyz, transfer to a contract
    tokenId = Long.toString(0);
    tokenValue = Long.valueOf(1);
    ...
    //tokenId is 0, transfer contract has wyz, transfer to normal account
    tokenId = Long.toString(0);
    tokenValue = Long.valueOf(1);
    callValue = Long.valueOf(1);
