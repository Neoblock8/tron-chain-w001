...
public class HttpTestMarket001 {
   ...
   * constructor.
   */
  @Test(enabled = true, description = "MarketSellAsset wyz with trc10 by http")
   ...
   * constructor.
   */
  @Test(enabled = true, description = "MarketCancelOrder wyz with trc10 by http")
