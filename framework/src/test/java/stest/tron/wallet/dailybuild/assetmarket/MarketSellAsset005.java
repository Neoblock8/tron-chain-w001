...
public class MarketSellAsset005 {
  ...
  byte [] wyz = ByteArray.fromString("_");
  ...
  @Test(enabled = true,description = "Create an order to sell Wyz and buy Trc10")
  void test01SellWyzBuyTrc10() {
    ...
    String txid = PublicMethed.marketSellAsset(testAddress002,testKey002,wyz,
    ...
    txid = PublicMethed.marketSellAsset(testAddress001, testKey001, assetAccountId001,
            sellTokenQuantity * 2,
            wyz, buyTokenQuantity * 2, blockingStubFull);
  ...
  @Test(enabled = true,description = "Create an order to sell Trc10 and buy Wyz")
  void test02SellTrc10BuyWyz() {
    long balanceAfter = PublicMethed.queryAccount(testKey001, blockingStubFull).getBalance();
    ...
    txid = PublicMethed.marketSellAsset(testAddress001, testKey001, wyz,
            sellTokenQuantity * 2,
