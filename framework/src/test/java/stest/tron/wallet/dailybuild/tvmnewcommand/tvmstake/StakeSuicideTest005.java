package stest.tron.wallet.dailybuild.wvmnewcommand.wvmstake;
...
public class StakeSuicideTest005 {
  ...
  @Test(enabled = false, description = "targetAddress is account no WYZ, and no frozen")
  void wvmStakeSuicideTest001() {
  ...
  @Test(enabled = false, description = "targetAddress is account 1 WYZ, and no frozen")
  void wvmStakeSuicideTest002() {
    ECKey ecKeyTargetAddress = new ECKey(Utils.getRandom());
    byte[] targetAddress = ecKeyTargetAddress.getAddress();
  ...
  @Test(enabled = false, description = "targetAddress is account 1 WYZ, and 1 frozen")
  void wvmStakeSuicideTest003() {
    ECKey ecKeyTargetAddress = new ECKey(Utils.getRandom());
    byte[] targetAddress = ecKeyTargetAddress.getAddress();
    String testKeyTargetAddress = ByteArray.toHexString(ecKeyTargetAddress.getPrivKeyBytes());
    Assert.assertTrue(PublicMethed
