...
public class WalletTestAssetIssue005 {
  ...
  public void testGetAssetIssueByName() {
    ...
    Assert.assertTrue(assetIssueByName.getWyzNum() > 0);
    ...
    Assert.assertFalse(assetIssueByName.getWyzNum() > 0);
  ...
  public Boolean createAssetIssue(byte[] address, String name, Long totalSupply, Integer wyzNum,
