...
public class TransferFailed005 {
  ...
  public void triggerContract01() {
    ...
    // transfer wyz to self`s account
    String param = "\"" + paramValue + "\",\"" + Base58.encode58Check(contractAddress) + "\"";
    String triggerTxid = PublicMethed
        .triggerContract(contractAddress, "testCallWyzInsufficientBalance(uint256,address)", param,
    ...
    // transfer wyz to unactivate account
    ...
    // transfer wyz to caller, value enough , function success contractResult(call_value) successed
    ...
    // transfer wyz to caller, value not enough, function success
  ...
  public void triggerContract02() {
    ...
    String triggerTxid = PublicMethed
        .triggerContract(contractAddress, "testCreateWyzInsufficientBalance(uint256)", param, false,
  ...
  public void triggerContract04() {
    ...
    TransactionExtention return1 = PublicMethed.triggerConstantContractForExtention(contractAddress,
        "testTransferWyzInsufficientBalance(uint256)", "1", false, 0L, 1000000000, "0", 0L,
        accountExcAddress, accountExcKey, blockingStubFull);
