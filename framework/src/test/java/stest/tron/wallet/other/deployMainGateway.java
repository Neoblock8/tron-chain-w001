...
public class deployMainGateway {
  ...
  private final String testDepositWyz = "324a2052e491e99026442d81df4d2777292840c1b3949e20696c49096"
      + "c6bacb7";
  private final byte[] testDepositAddress = PublicMethed.getFinalAddress(testDepositWyz);
  ...
  public void test1DepositTrc20001() {
    ...
    Assert.assertTrue(PublicMethed
        .sendcoin(depositAddress, 1000_000_000L, testDepositAddress, testDepositWyz,
            blockingStubFull));
