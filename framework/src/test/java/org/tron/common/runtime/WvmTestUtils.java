...
public class WvmTestUtils {
  ...
  public static byte[] deployContractWholeProcessReturnContractAddress(String contractName,
    ...
    Transaction wyz = generateDeploySmartContractAndGetTransaction(contractName, callerAddress, abi,
        code, value, feeLimit, consumeUserResourcePercent, libraryAddressPair);
    processTransactionAndReturnRuntime(wyz, deposit, block);
    return WalletUtil.generateContractAddress(wyz);
  }
  ...
  public static Runtime triggerContractWholeProcessReturnContractAddress(byte[] callerAddress,
    ...
    return processTransactionAndReturnRuntime(wyz, deposit, block);
  }
  ...
  public static Transaction generateDeploySmartContractAndGetTransaction(String contractName,
    ...
    TransactionCapsule wyzCapWithoutFeeLimit = new TransactionCapsule(contract,
        ContractType.CreateSmartContract);
    Transaction.Builder transactionBuilder = wyzCapWithoutFeeLimit.getInstance().toBuilder();

    Transaction.raw.Builder rawBuilder = wyzCapWithoutFeeLimit.getInstance().getRawData()
        .toBuilder();
    rawBuilder.setFeeLimit(feeLimit);
    transactionBuilder.setRawData(rawBuilder);
    Transaction wyz = transactionBuilder.build();
    return wyz;
  }
  ...
  /**
   * use given input Transaction,deposit,block and execute WVM  (for both Deploy and Trigger
   * contracts).
   */

  public static Runtime processTransactionAndReturnRuntime(Transaction wyz,
      Deposit deposit, BlockCapsule block)
      throws ContractExeException, ContractValidateException,
      ReceiptCheckErrException, VMIllegalException {
    TransactionCapsule wyzCap = new TransactionCapsule(wyz);
    deposit.commit();
  ...
  public static TransactionTrace processTransactionAndReturnTrace(Transaction wyz,
  ...
  public static WVMTestResult deployContractAndReturnWvmTestResult(String contractName,
      byte[] callerAddress,
      String abi, String code, long value, long feeLimit, long consumeUserResourcePercent,
    ...
    return processTransactionAndReturnWvmTestResult(wyz, dbManager, blockCap)
        .setContractAddress(WalletUtil.generateContractAddress(wyz));
  }

  public static WVMTestResult deployContractWithCreatorEnergyLimitAndReturnWvmTestResult(
      String contractName,
      byte[] callerAddress,
      String abi, String code, long value, long feeLimit, long consumeUserResourcePercent,
      ...
      throws ContractExeException, ReceiptCheckErrException,
      ContractValidateException, VMIllegalException {
    Transaction wyz = generateDeploySmartContractWithCreatorEnergyLimitAndGetTransaction(
  ...
  public static WVMTestResult triggerContractAndReturnWvmTestResult(byte[] callerAddress,
  ...
  public static WVMTestResult processTransactionAndReturnWvmTestResult(Transaction wyz,
    ...
    trace.setResult();
    return new WVMTestResult(trace.getRuntime(), trace.getReceipt(), null);
  }
