...
public class InterpreterTest {
  ...
  @Test
  public void teswvmException() throws ContractValidateException {
    VM vm = new VM();
    ...
    // 0x60 0x00 - PUSH 0x00
    // 0x56      - JUMP to 0
    Transaction wyz = Transaction.getDefaultInstance();
    InternalTransaction interWyz = new InternalTransaction(wyz, WyzType.WYZ_UNKNOWN_TYPE);
    program = new Program(op, invoke, interWyz);
