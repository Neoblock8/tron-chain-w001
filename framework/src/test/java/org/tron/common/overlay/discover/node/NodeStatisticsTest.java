...
public class NodeStatisticsTest {
  ...
  public void testMessage() {
    ...
    InventoryMessage invMsgWyz =
        new InventoryMessage(new ArrayList<>(), Protocol.Inventory.InventoryType.WYZ);
    String inventoryMessageStr = invMsgWyz.toString();
    Assert.assertNotNull(inventoryMessageStr);
    statistics.addTcpInMessage(invMsgWyz);
    statistics.addTcpOutMessage(invMsgWyz);
    ...
    FetchInvDataMessage fetchInvDataWyz =
        new FetchInvDataMessage(new ArrayList<>(), Protocol.Inventory.InventoryType.WYZ);
    statistics.addTcpInMessage(fetchInvDataWyz);
    statistics.addTcpOutMessage(fetchInvDataWyz);
    ...
    Assert.assertEquals(1, statistics.tronInWyzFetchInvData.getTotalCount());
    ...
    Assert.assertEquals(1, statistics.tronInWyzs.getTotalCount());
