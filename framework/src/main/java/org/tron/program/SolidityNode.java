...
import org.tron.core.net.WyzthNetService;
...
public class SolidityNode {
  ...
  public static void main(String[] args) {
    ...
    ApplicationContext context = new WyzthApplicationContext(DefaultConfig.class);
    ...
    nodeManager.close();
    WyzthNetService WyzthNetService = context.getBean(WyzthNetService.class);
    WyzthNetService.stop();
