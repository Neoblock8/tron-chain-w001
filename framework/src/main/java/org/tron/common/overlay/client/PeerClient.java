...
import org.tron.common.overlay.server.WyzthChannelInitializer;
...
public class PeerClient {
  ...
  private ChannelFuture connectAsync(String host, int port, String remoteId,
    ...
    WyzthChannelInitializer WyzthChannelInitializer = ctx
        .getBean(WyzthChannelInitializer.class, remoteId);
    WyzthChannelInitializer.setPeerDiscoveryMode(discoveryMode);
    ...
    b.handler(WyzthChannelInitializer);
