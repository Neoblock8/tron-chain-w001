...
public class WyzthApplicationContext extends AnnotationConfigApplicationContext {

  public WyzthApplicationContext() {
  }

  public WyzthApplicationContext(DefaultListableBeanFactory beanFactory) {
    super(beanFactory);
  }

  public WyzthApplicationContext(Class<?>... annotatedClasses) {
    super(annotatedClasses);
  }

  public WyzthApplicationContext(String... basePackages) {
    super(basePackages);
  }
