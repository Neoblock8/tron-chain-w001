...
public class WyzthNetService {
  ...
  public void start() {
    ...
    logger.info("WyzthNetService start successfully.");
  }
  ...
  public void stop() {
    ...
    logger.info("WyzthNetService closed successfully.");
  }
  ...
  protected void onMessage(PeerConnection peer, WyzthMessage msg) {
    try {
      switch (msg.getType()) {
  ...
  private void processException(PeerConnection peer, WyzthMessage msg, Exception ex) {
    ReasonCode code;
