 ...
 * msg factory.
 */
public class WyzthMessageFactory extends MessageFactory {

  private static final String DATA_LEN = ", len=";

  @Override
  public WyzthMessage create(byte[] data) throws Exception {
  ...
  private WyzthMessage create(byte type, byte[] packed) throws Exception {
