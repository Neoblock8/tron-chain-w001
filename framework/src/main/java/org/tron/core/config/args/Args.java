...
public class Args extends CommonParameter {
  ...
  public static void clearParam() {
    ...
    PARAMETER.allowWvmTransferTrc10 = 0;
    PARAMETER.allowWvmConstantinople = 0;
    PARAMETER.allowDelegateResource = 0;
    PARAMETER.allowSameTokenName = 0;
    PARAMETER.allowWvmSolidity059 = 0;
    ...
    PARAMETER.wyzExpirationTimeInMilliseconds = 0;
    ...
    PARAMETER.allowWvmIstanbul = 0;
    PARAMETER.allowWvmStake = 0;
    PARAMETER.allowWvmAssetIssue = 0;
  ...
  public static void setParam(final String[] args, final String confFileName) {
    ...
    PARAMETER.netMaxWyzPerSecond = config.hasPath(Constant.NODE_NET_MAX_WYZ_PER_SECOND)
        ? config.getInt(Constant.NODE_NET_MAX_WYZ_PER_SECOND)
        : NetConstants.NET_MAX_WYZ_PER_SECOND;
    ...
    PARAMETER.allowWvmTransferTrc10 =
        config.hasPath(Constant.COMMITTEE_ALLOW_WVM_TRANSFER_TRC10) ? config
            .getInt(Constant.COMMITTEE_ALLOW_WVM_TRANSFER_TRC10) : 0;

    PARAMETER.allowWvmConstantinople =
        config.hasPath(Constant.COMMITTEE_ALLOW_WVM_CONSTANTINOPLE) ? config
            .getInt(Constant.COMMITTEE_ALLOW_WVM_CONSTANTINOPLE) : 0;

    PARAMETER.allowWvmSolidity059 =
        config.hasPath(Constant.COMMITTEE_ALLOW_WVM_SOLIDITY059) ? config
            .getInt(Constant.COMMITTEE_ALLOW_WVM_SOLIDITY059) : 0;
    ...
    PARAMETER.needToUpdateAsset =
        config.hasPath(Constant.STORAGE_NEEDTO_UPDATE_ASSET) ? config
            ...
            : true;
    PARAMETER.wyzReferenceBlock = config.hasPath(Constant.WYZ_REFERENCE_BLOCK)
        ? config.getString(Constant.WYZ_REFERENCE_BLOCK) : "head";

    PARAMETER.wyzExpirationTimeInMilliseconds =
        config.hasPath(Constant.WYZ_EXPIRATION_TIME_IN_MILLIS_SECONDS)
            && config.getLong(Constant.WYZ_EXPIRATION_TIME_IN_MILLIS_SECONDS) > 0
            ? config.getLong(Constant.WYZ_EXPIRATION_TIME_IN_MILLIS_SECONDS)
    ...
    PARAMETER.allowWvmIstanbul =
        config.hasPath(Constant.COMMITTEE_ALLOW_WVM_ISTANBUL) ? config
            .getInt(Constant.COMMITTEE_ALLOW_WVM_ISTANBUL) : 0;
    ...
    PARAMETER.allowWvmStake =
            config.hasPath(Constant.COMMITTEE_ALLOW_WVM_STAKE) ? config
                    .getInt(Constant.COMMITTEE_ALLOW_WVM_STAKE) : 0;

    PARAMETER.allowWvmAssetIssue =
            config.hasPath(Constant.COMMITTEE_ALLOW_WVM_ASSETISSUE) ? config
                    .getInt(Constant.COMMITTEE_ALLOW_WVM_ASSETISSUE) : 0;
