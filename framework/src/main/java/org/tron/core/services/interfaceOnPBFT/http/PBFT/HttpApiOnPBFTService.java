...
import org.tron.core.services.interfaceOnPBFT.http.GetBurnWyzOnPBFTServlet;
...
public class HttpApiOnPBFTService implements Service {
  ...
  @Autowired
  private GetBurnWyzOnPBFTServlet getBurnWyzOnPBFTServlet;
  ...
  public void start() {
    try {
      ...
      context.addServlet(new ServletHolder(getBurnWyzOnPBFTServlet),
          "/getburnwyz");
