...
import org.tron.core.services.interfaceOnSolidity.http.GetBurnWyzOnSolidityServlet;
...
public class HttpApiOnSolidityService implements Service {
  ...
  @Autowired
  private GetBurnWyzOnSolidityServlet getBurnWyzOnSolidityServlet;
  @Autowired
  ...
  public void start() {
    try {
      ...
      context
          .addServlet(new ServletHolder(getBurnWyzOnSolidityServlet), "/walletsolidity/getburnwyz");
