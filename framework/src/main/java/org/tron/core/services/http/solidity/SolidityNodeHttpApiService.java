...
import org.tron.core.services.http.GetBurnWyzServlet;
...
public class SolidityNodeHttpApiService implements Service {
  ...
  @Autowired
  private GetBurnWyzServlet getBurnWyzServlet;
  @Autowired
  ...
  public void start() {
    try {
      ...
      context.addServlet(new ServletHolder(getBurnWyzServlet), "/walletsolidity/getburnwyz");
