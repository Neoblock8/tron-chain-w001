    ...
    for (Map.Entry<Long, Long> entry : map.entrySet()) {
      ...
      switch (proposalType) {
        ...
        case ALLOW_WVM_TRANSFER_TRC10: {
          manager.getDynamicPropertiesStore().saveAllowWvmTransferTrc10(entry.getValue());
          break;
        }
        ...
        case ALLOW_WVM_CONSTANTINOPLE: {
          manager.getDynamicPropertiesStore().saveAllowWvmConstantinople(entry.getValue());
          manager.getDynamicPropertiesStore().addSystemContractAndSetPermission(48);
          break;
        }
        case ALLOW_WVM_SOLIDITY_059: {
          manager.getDynamicPropertiesStore().saveAllowWvmSolidity059(entry.getValue());
          break;
        }
        ...
        case ALLOW_WVM_ISTANBUL: {
          manager.getDynamicPropertiesStore().saveAllowWvmIstanbul(entry.getValue());
          break;
        }
        ...
        //  manager.getDynamicPropertiesStore().saveAllowWvmStake(entry.getValue());
        //  break;
        //}
        //case ALLOW_WVM_ASSET_ISSUE: {
        //  manager.getDynamicPropertiesStore().saveAllowWvmAssetIssue(entry.getValue());
        //  break;
        //}
