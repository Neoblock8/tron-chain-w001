...
public class Parameter {
  ...
  public static class ChainSymbol {
    ...
    public static final byte[] WYZ_SYMBOL_BYTES = "_".getBytes(); // WYZ symbol
  }
  ...
  public class ChainConstant {
    ...
    public static final int BLOCK_PRODUCED_INTERVAL = 12000; //ms,produce block period, must be divisible by 60. millisecond
    ...
    public static final long WYZ_PRECISION = 1000_000L;
  }
