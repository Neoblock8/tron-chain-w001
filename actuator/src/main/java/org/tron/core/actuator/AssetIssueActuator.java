...
public class AssetIssueActuator extends AbstractActuator {
  ...
  public boolean validate() throws ContractValidateException {
    ...
    if (dynamicStore.getAllowSameTokenName() != 0) {
      ...
      if (("wyz").equals(name)) {
        throw new ContractValidateException("assetName can't be wyz");
      }
    }
    ...
    if (assetIssueContract.getWyzNum() <= 0) {
      throw new ContractValidateException("WyzNum must greater than 0!");
    }
