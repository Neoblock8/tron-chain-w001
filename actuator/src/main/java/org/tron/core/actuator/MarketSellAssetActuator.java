...
public class MarketSellAssetActuator extends AbstractActuator {
  ...
  private void matchSingleOrder(MarketOrderCapsule takerOrderCapsule,
    ...
    // for makerPrice,sellToken is A,buyToken is WYZ.
    // for takerPrice,buyToken is A,sellToken is WYZ.

    // makerSellTokenQuantity_A/makerBuyTokenQuantity_WYZ =
    //   takerBuyTokenQuantityCurrent_A/takerSellTokenQuantityRemain_WYZ
    // => takerBuyTokenQuantityCurrent_A = takerSellTokenQuantityRemain_WYZ *
    //   makerSellTokenQuantity_A/makerBuyTokenQuantity_WYZ
    ...
    if (takerBuyTokenQuantityRemain == makerOrderCapsule.getSellTokenQuantityRemain()) {
      ...
      // makerSellTokenQuantityRemain_A/makerBuyTokenQuantityCurrent_WYZ =
      //   makerSellTokenQuantity_A/makerBuyTokenQuantity_WYZ
      // => makerBuyTokenQuantityCurrent_WYZ = makerSellTokenQuantityRemain_A *
      //   makerBuyTokenQuantity_WYZ / makerSellTokenQuantity_A
    ...
    addWyzOrToken(takerOrderCapsule, takerBuyTokenQuantityReceive, takerAccountCapsule);
    addWyzOrToken(makerOrderCapsule, makerBuyTokenQuantityReceive);
  ...
  // for taker
  private void addWyzOrToken(MarketOrderCapsule orderCapsule, long num,
