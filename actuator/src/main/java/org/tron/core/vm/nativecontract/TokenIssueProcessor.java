...
public class TokenIssueProcessor {
  ...
  public void execute(Object contract, Repository repository) {
    ...
    // spend 1024wyz for assetissue, send to blackhole address
  ...
  public void validate(Object contract, Repository repository) throws ContractValidateException {
    ...
    if ((WYZ.equalsIgnoreCase(ByteArray.toStr(tokenIssueParam.getName())))) {
      throw new ContractValidateException("assetName can't be wyz or null");
    }
