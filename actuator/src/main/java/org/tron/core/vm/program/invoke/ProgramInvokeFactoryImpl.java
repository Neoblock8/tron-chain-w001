...
public class ProgramInvokeFactoryImpl implements ProgramInvokeFactory {
  ...
  @Override
  public ProgramInvoke createProgramInvoke(InternalTransaction.WyzType wyzType,
    ...
    if (wyzType == WYZ_CONTRACT_CREATION_TYPE) {
    ...
    } else if (wyzType == WYZ_CONTRACT_CALL_TYPE) {
