...
import org.tron.core.exception.WyzthException;
...
public class Program {
  ...
  public static class Exception {
    ...
    public static PrecompiledContractException contractValidateException(WyzthException e) {
      return new PrecompiledContractException(e.getMessage());
    }

    public static PrecompiledContractException contractExecuteException(WyzthException e) {
      return new PrecompiledContractException(e.getMessage());
    }
